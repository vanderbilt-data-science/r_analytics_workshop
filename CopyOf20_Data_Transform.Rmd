...
Let's say that we'd like to do the above calculation, and then look at the most-delayed flights, and filter out those with delays less than an hour. We could right the following:
...
flights3 <- arrange(flights2, dep_delay)

flights4 <- filter(flights3, dep_delay > 60)
