...
Let's save our data to practice reading it in.

```{r}
write_csv(flights, "data/flights.csv")
write_delim(weather, "data/weather.txt", delim = "|")
write_dta(planes, "data/planes.dta")
write_excel_csv(airports, "data/airports.csv")
